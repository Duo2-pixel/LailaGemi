...
# --- NEW: AI-based name extraction ---
async def get_name_from_ai(user_message: str):
    """Uses AI to extract a user's name from a message."""
    prompt = f"Given the user message, 'What is my name? my name is {user_message}. My name is Adhyan' Does this message contain a person's name? If yes, extract ONLY the name. If not, respond with 'NoName'."
    try:
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # REPLACE 'YOUR_START_PHOTO_FILE_ID_HERE' with your actual photo ID
    photo_file_id = 'YOUR_START_PHOTO_FILE_ID_HERE'
    try:
        await context.bot.send_photo(
            chat_id=chat_id,
            photo=photo_file_id,
...
async def stats_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # REPLACE 'YOUR_STATS_PHOTO_FILE_ID_HERE' with your actual photo ID
    photo_file_id = 'YOUR_STATS_PHOTO_FILE_ID_HERE'
    try:
        await context.bot.send_photo(
            chat_id=chat_id,
            photo=photo_file_id,
